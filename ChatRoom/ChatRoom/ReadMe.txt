...
应用程序向导已为您创建了此 ChatRoom 应用程序。此应用程序不仅演示 Microsoft 基础类的基本使用方法，还可作为您编写应用程序的起点。
...
res\ChatRoom.ico
    这是用作应用程序图标的图标文件。此图标包括在主资源文件 ChatRoom.rc 中。
...
LoginDlg.h、LoginDlg.cpp - 对话框
    这些文件包含 CLoginDlg 类。此类定义应用程序的主对话框的行为。对话框模板包含在 ChatRoom.rc 中，该文件可以在 Microsoft Visual C++ 中编辑。
